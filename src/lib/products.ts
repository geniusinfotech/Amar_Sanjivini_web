...
export const products: Product[] = [
  {
    id: "1",
    name: "Copper Sulphate (Blue Vitriol)",
    price: "₹700 / 50kg bag",
    category: "Pesticides", // Changed category to better reflect Copper Sulphate's primary use
    image: "/Product-image/product1.jpeg",
    description:
      "An effective fungicide and algaecide that also provides necessary Copper micronutrients.",
    details: [
      // Copper Sulphate is generally not a 'full balanced diet' fertilizer.
      // It's a micronutrient supplement and a powerful pesticide/fungicide.
      "Effective control against fungal diseases and mildew in fruits, vegetables, and field crops.",
      "Essential Copper micronutrient for enzyme activity and chlorophyll formation.",
      "Used in the preparation of Bordeaux mixture for historical and reliable disease control.",
      "Acts as an algaecide in irrigation water and standing fields.",
      "100% water-soluble powder form for easy mixing and application.",
      "Helps correct Copper deficiency symptoms (like pale leaves or delayed flowering).",
    ],
    usageInstructions:
      "For foliar spray, mix 2 – 3 grams per liter of water. For root drenching/drip, use as per crop-specific Copper deficiency recommendations. Consult a local agricultural expert before widespread application.",
    featured: true,
  },
  {
    id: "2",
